...
class EnsembleModel:
    ...
    def merge_sub_models(self, func, **kwargs):
        ...
        self.model = func([model for model in self.sub_models], **kwargs)
    ...
    def compiler(self):
        ...
        self.model = Model(self.input_layers, self.model)
        return ModelCompiler(self)

    # TODO: Add fit method cause its important
...
class ModelCompiler:
    ...
    def compile(self, **kwargs):
        print(self.model)
        return self.model.model.compile(
            self.optimizer,
            loss=self.loss,
